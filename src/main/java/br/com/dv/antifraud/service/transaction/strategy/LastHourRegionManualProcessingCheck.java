...
@Component
public class LastHourRegionManualProcessingCheck implements TransactionCheck {

    private final TransactionRepository repository;

    public LastHourRegionManualProcessingCheck(TransactionRepository repository) {
